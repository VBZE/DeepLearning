...
save_path = '/home/vbze/Image/UNet'
weight_path = '/home/vbze/Weight/UNet/unet.pth'  # 定义权重地址
...
if __name__ == '__main__':
    unet = UNet().to(device)
    data_loader = DataLoader(MyTrainDataSet(data_path), batch_size=16, shuffle=True)
    ...
    optimizer = optim.Adam(unet.parameters(), lr=learn_rate)  # 优化器
